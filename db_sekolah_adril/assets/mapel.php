...
<div class="container py-4">
  ...
  <div class="d-flex justify-content-between mb-3">
    ...
    <button class="btn btn-primary" data-ba-toggle="modal" data-ba-target="#modal Tambah">+ Tambah Mapel</button>
  </div>
  ...
  if (isset($_GET['hapus'])) {
    $id = $_GET['hapus'];
    mysqli_query ($koneksi, "DELETE FROM mata_pelajaran WHERE id mapel='$id'");
  ...
  if (isset($_POST['update'])) {
    ...
    $nama = $_POST['nama_mapel'];
    $id_guru = $_POST['id_guru'];
    mysqli_query ($koneksi, "UPDATE mata_pelajaran SET nama_mapel='$nama', id guru='$id_guru' WHERE id_mapel='$id'");
    echo "<meta http-equiv='refresh' content='0;url=mapel.php'>";
  }
  ?>
      ...
      <div class="modal-content">
        ...
        <form method="POST">
          <div class="modal-body">
            ...
            <select name="id guru" class="form-select mb-2" required>
              <option value="">-- Pilih Guru --</option>
              <?php
              $guruList = mysqli_query($koneksi, "SELECT id guru, nama FROM guru ORDER BY nama ASC");
